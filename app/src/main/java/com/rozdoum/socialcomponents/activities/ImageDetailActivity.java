...
public class ImageDetailActivity extends BaseActivity {
    ...
    private static final String Attach = ImageDetailActivity.class.getSimpleName();

    public static final String Img_key = "ImageDetailActivity.Img_key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String imageUrl = getIntent().getStringExtra(Img_key);

        int Img_side = calc_max_Image_Side();
        ...
        Glide.with(this)
                ...
                .fitCenter()
                .into(new SimpleTarget<Bitmap>(Img_side, Img_side) {
                    @Override
    ...
    private int calc_max_Image_Side() {
